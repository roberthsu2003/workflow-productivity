...
## 🎯 職場延伸實戰案例庫（收納於「常見的 AI 應用」）

如果你想進一步探索更多真實世界的複雜職場任務，我們在 [常見的 AI 應用](../../常見的AI應用/README.md) 中準備了完整的實戰範例庫：

### 📂 [林宛柔實戰案例：排班、素材整合、數據分析](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/README.md)
此案例涵蓋三個難度與性質截然不同的實務挑戰，完整示範對話、Canvas 畫布與專案模式的最佳工具搭配：

1. **[需求 4-1：服務業人力排班](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/README.md#需求-4-1服務業人力排班)**（建議工具：對話 / Canvas 畫布）
   - **協作亮點**：每週人力變動大，全部用貼的不佔上傳額度；指定存成 Markdown 檔即可在右側 Canvas 畫布逐欄調整，並加入「無法滿足規則就直接回報人力不足」的關鍵防呆條款。
   - 附屬素材：[素材檢核表.md](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/素材檢核表.md) ｜ [`4-1_服務業人力排班提示詞.txt`](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/4-1_服務業人力排班提示詞.txt)

2. **[需求 4-2：素材整合快速上架社群](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/README.md#需求-4-2素材整合快速上架社群)**（建議工具：專案 / Work 產內容包）
   - **協作亮點**：一次產出 IG 貼文、FB 故事長文、官網標題 3 版、短影音腳本（15s/30s）與封面文字；提供品牌調性與過去表現優良的貼文作為風格錨定，建立禁用詞防護。
   - 附屬素材：[`4-2_社群素材多格式產出提示詞.txt`](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/4-2_社群素材多格式產出提示詞.txt)

3. **[需求 4-3：官網 + FB + IG 數據交叉分析](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/README.md#需求-4-3官網--fb--ig-數據交叉分析)**（建議工具：專案 / Advanced Data Analysis）
   - **協作亮點**：跨平台指標對照與 CSV 貼入分析；重點在「紅燈在取數對齊，綠燈在解讀洞察」，由 AI 自動偵測異常波動（±30%）並給出建議查證方向。
   - 附屬素材：[`4-3_跨平台成效分析專案指令.txt`](../../常見的AI應用/實戰案例_林宛柔_排班_素材整合_數據分析/4-3_跨平台成效分析專案指令.txt)
