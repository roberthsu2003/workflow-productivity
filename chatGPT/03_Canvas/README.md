...
1. **[範例 01：門市人力排班與規則檢核](../../常見的AI應用/實戰範例/01_門市人力排班與規則檢核/README.md)**（建議工具：對話 / Canvas 畫布）
   - **協作亮點**：每週人力變動大，全部用貼的不佔上傳額度；指定存成 Markdown 檔即可在右側 Canvas 畫布逐列微調排班表，並加入「無法滿足規則就直接回報人力不足」的關鍵防呆條款。
   - 附屬素材：[素材檢核表.md](../../常見的AI應用/實戰範例/01_門市人力排班與規則檢核/素材檢核表.md) ｜ [`門市人力排班提示詞.txt`](../../常見的AI應用/實戰範例/01_門市人力排班與規則檢核/門市人力排班提示詞.txt)

2. **[範例 02：社群行銷素材多格式整合產出](../../常見的AI應用/實戰範例/02_社群行銷素材多格式產出/README.md)**（建議工具：專案 / Work 產內容包）
   - **協作亮點**：一次產出 IG 貼文、FB 故事長文、官網標題 3 版、短影音腳本（15s/30s）與封面文字；提供品牌調性與過去成效最佳的貼文作為風格錨定，建立禁用詞防護。
   - 附屬素材：[`社群素材多格式產出提示詞.txt`](../../常見的AI應用/實戰範例/02_社群行銷素材多格式產出/社群素材多格式產出提示詞.txt)

3. **[範例 03：跨平台成效數據交叉分析與異常診斷](../../常見的AI應用/實戰範例/03_跨平台成效數據交叉分析/README.md)**（建議工具：專案 / Advanced Data Analysis）
   - **協作亮點**：跨平台指標對照與 CSV 貼入分析；重點在「紅燈在取數對齊，綠燈在解讀洞察」，由 AI 自動偵測異常波動（±30%）並給出具體的行銷檢討與查證方向。
   - 附屬素材：[`跨平台成效分析專案指令.txt`](../../常見的AI應用/實戰範例/03_跨平台成效數據交叉分析/跨平台成效分析專案指令.txt)
