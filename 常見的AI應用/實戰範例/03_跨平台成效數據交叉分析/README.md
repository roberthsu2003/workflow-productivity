...
| [`跨平台成效偽數據.md`](./跨平台成效偽數據.md) | 輕量素材 | 轉換為 Markdown 表格版本，含指標對照定義與 8 月異常痛點說明，**最推薦直接貼入 AI**。 |
| [`3-1_白話自然語言發想提示詞.txt`](./3-1_白話自然語言發想提示詞.txt) | 提示詞 (輸入) | 學生第一步發送給 AI 的白話指令，請 AI 將數據轉化為 RTCCF 框架。 |
...
請學生在任何 AI 對話框輸入 [`3-1_白話自然語言發想提示詞.txt`](./3-1_白話自然語言發想提示詞.txt) 的內容，並附上數據表格。

> **學生輸入的白話範例：**
> *「我是品牌行銷數據分析，每個月從 GA4、FB、IG 抓數據在 Excel。我已經把 Excel 轉成省 Token 的 Markdown 表格（附在下方）。目前老闆很困惑：為什麼 8 月社群曝光觸及歷史新高，但官網轉換率反而暴跌至 1.9%？請扮演數據分析顧問兼 AI 提示詞專家，幫我用 RTCCF 框架設計一份跨平台交叉分析提示詞，指定儲存為 Markdown 報告，方便我在 Canvas 畫布微調。」*
