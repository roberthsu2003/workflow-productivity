...
4. **Instagram 限動 / Reels / Shorts 滿版專用圖（9:16 直式）**：
   - 檔名：`新品上市宣傳圖_IG限動Reels_1080x1920.jpg`（1080 × 1920 px，滿版背景採高斯模糊延伸，中央放置高清主圖）
...
| 檔案名稱 | 類型 | 說明 |
| :--- | :---: | :--- |
| 🏆 [**`秋季新品_焦糖焙香燕麥拿鐵_社群全格式素材包.md`**](./秋季新品_焦糖焙香燕麥拿鐵_社群全格式素材包.md) | **完成作品** | **最終文案成果檔**：包含 IG、FB、官網標題、短影音 15s/30s 分鏡表與封面短標。 |
