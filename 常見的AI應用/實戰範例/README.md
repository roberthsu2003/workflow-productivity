...
| 範例主題 | 採用代理平台 | 推薦操作模式 | 核心業務情境 | 交付成品與素材 |
| :--- | :---: | :--- | :--- | :--- |
| **[跨平台成效數據交叉分析](./跨平台成效數據交叉分析/README.md)** | 🟢 **ChatGPT Agent 平台** | Work 模式 / Canvas 雙欄畫布 | Excel 轉文字省 Token、GA4/FB/IG 跨平台漏斗比對、8 月流量暴衝但轉換暴跌異常診斷 | <ul><li>[跨平台成效偽數據.md](./跨平台成效數據交叉分析/跨平台成效偽數據.md)</li><li>[3-1 白話自然語言提示詞](./跨平台成效數據交叉分析/3-1_白話自然語言發想提示詞.txt)</li><li>[3-2 AI產出RTCCF提示詞](./跨平台成效數據交叉分析/3-2_AI產出之RTCCF數據分析提示詞.txt)</li></ul> |
| **[社群行銷素材多格式產出](./社群行銷素材多格式產出/README.md)** | 🟢 **ChatGPT Agent 平台** | Work 模式 / Canvas 雙欄畫布 | 咖啡新品上市宣傳照、品牌調性、禁用詞、一次產出 IG/FB/官網/短影音分鏡 | <ul><li>[社群行銷活動偽素材.md](./社群行銷素材多格式產出/社群行銷活動偽素材.md)</li><li>[2-1 白話自然語言提示詞](./社群行銷素材多格式產出/2-1_白話自然語言發想提示詞.md)</li><li>[2-2 AI產出RTCCF提示詞](./社群行銷素材多格式產出/2-2_AI產出之RTCCF行銷提示詞.md)</li></ul> |
| **[便利超商門市排班與規則檢核](./便利超商門市排班與規則檢核/README.md)** | 🟢 **ChatGPT Agent 平台** | Work 模式 / Canvas 雙欄畫布 | 24 小時三班制、勞基法 11 小時輪班間隔、專職大夜防開天窗、早晚尖峰雙人制 | <ul><li>[門市排班偽素材.md](./便利超商門市排班與規則檢核/門市排班偽素材.md)</li><li>[1-1 白話自然語言提示詞](./便利超商門市排班與規則檢核/1-1_白話自然語言發想提示詞.md)</li><li>[1-2 AI產出RTCCF提示詞](./便利超商門市排班與規則檢核/1-2_AI產出之RTCCF排班提示詞.md)</li></ul> |
| **[進銷存出貨沖帳與銷退核銷](./出貨沖帳/README.md)** | 🟢 **ChatGPT Agent 平台** | Work 模式 / Canvas 雙欄畫布 | ERP 銷退單號自動比對補齊、進銷退四欄平衡核銷、防範過度複雜、主動提問確認機制 | <ul><li>[出貨沖帳原始數據.md](./出貨沖帳/出貨沖帳原始數據.md)</li><li>[4-1 白話自然語言提示詞](./出貨沖帳/4-1_白話自然語言發想提示詞.md)</li><li>[4-2 AI產出RTCCF提示詞](./出貨沖帳/4-2_AI產出之RTCCF出貨沖帳提示詞.md)</li><li>[4-3 生成Excel發布檔提示詞](./出貨沖帳/4-3_生成出貨沖帳完成Excel發布檔提示詞.md)</li><li>[出貨沖帳_已完成沖帳.xlsx](./出貨沖帳/出貨沖帳_已完成沖帳.xlsx)</li></ul> |

---

## ⚡ 核心人機協商工作流示範（以跨平台成效數據分析為例）
...
```mermaid
flowchart TD
    Start["職場新任務發起"] --> Q1{"跨平台指標比對？<br>異常波動診斷？"}
    Q1 -- 是 --> Tool1["📊 Work 模式 / 數據交叉分析報告<br><b>（跨平台成效數據交叉分析）</b>"]
    Q1 -- 否 --> Q2{"需要一次整合產出<br>多種格式內容包？"}
    Q2 -- 是 --> Tool2["💼 Work 模式 / Canvas 雙欄微調<br><b>（社群行銷素材多格式產出）</b>"]
    Q2 -- 否 --> Q3{"複雜排班與<br>法規防呆檢核？"}
    Q3 -- 是 --> Tool3["💬 Work 模式 + Canvas 雙欄畫布<br><b>（便利超商門市排班與規則檢核）</b>"]
    Q3 -- 否 --> Tool4["📗 Work 模式 + Python 自動化發布<br><b>（進銷存出貨沖帳與銷退核銷）</b>"]
```
