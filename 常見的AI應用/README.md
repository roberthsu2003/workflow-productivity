...
精選三大代理平台（ChatGPT、Claude.ai、Google Antigravity）在現代職場的真實落地實戰，**每個範例皆清楚標註所採用的代理平台**：
- **[現代職場實戰範例庫](./實戰範例/README.md)**  
  - **[跨平台成效數據交叉分析](./實戰範例/跨平台成效數據交叉分析/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（專案 / ADA 數據分析沙盒、異常波動診斷）
  - **[社群行銷素材多格式產出](./實戰範例/社群行銷素材多格式產出/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（專案 / Work 模式多格式文案包、影音腳本、禁詞防護）
  - **[便利超商門市排班與規則檢核](./實戰範例/便利超商門市排班與規則檢核/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（對話 / Canvas 雙欄畫布微調、規則防呆）
  - **[進銷存出貨沖帳與銷退核銷](./實戰範例/出貨沖帳/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（ERP 單號比對補齊、四欄平衡核銷、防範過度複雜與主動提問機制）
