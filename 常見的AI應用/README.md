...
- **[現代職場實戰範例庫](./實戰範例/README.md)**  
  - **[範例 01：門市人力排班與規則檢核](./實戰範例/01_門市人力排班與規則檢核/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（對話 / Canvas 雙欄畫布微調、規則防呆）
  - **[範例 02：社群行銷素材多格式產出](./實戰範例/02_社群行銷素材多格式產出/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（專案 / Work 模式多格式文案包、影音腳本、禁詞防護）
  - **[範例 03：跨平台成效數據交叉分析](./實戰範例/03_跨平台成效數據交叉分析/README.md)** ｜ 🟢 **ChatGPT Agent 平台**（專案 / ADA 數據分析沙盒、異常波動診斷）
