...
> 💡 **核心操作心法：千萬別自己手打 ROSES！善用 Artifacts 側邊欄！**  
> 很多學員看到一份嚴謹的 ROSES 規格書時會望而卻步。**請記住：真實的高手絕不是手打整份規格！**  
> 本專題建議全程搭配 **Claude Artifacts（側邊欄模式）** 實作：人類只要在左側對話框輸入簡單白話，像程式設計師一樣逐步把「順序、分支、自檢」等陳述句（Statements）講給 AI 聽，由 AI 在右側畫布逐步迭代更新出最頂級的工作規格書！
