...
```text
請你扮演有十年商務溝通經驗的專家，幫我寫一封給客戶的致歉 Email。我是華梵大學圖書館採購承辦，對象是三民書局的聯絡窗口；我們訂的 50 本書因供應商備料不足，沒辦法在原定日出貨，預計下週五才能出貨，我們會提供九折優惠券當補償。請用繁體中文、正式但誠懇的語氣，全文約 200 字以內（不含主旨），不要承諾文件沒寫的額外賠償。請先給一行主旨建議，內文依序寫：致歉、簡短說明原因、預計出貨日、補償說明、再次致歉與感謝。
```
