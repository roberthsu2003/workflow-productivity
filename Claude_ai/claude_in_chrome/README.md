...
<details>
<summary>🏢 <b>企業實戰案例：創新工業技術移轉（ITIC）— 每日產業新聞與情報自動化蒐集</b></summary>

> **情境說明**：此範例為「創新工業技術移轉股份有限公司 (ITIC)」客製化實戰 Prompt。創投與技轉團隊每日需監控投資組合公司及重點產業（如半導體先進封裝、AI 晶片、矽光子等）的最新動態，透過關鍵字組合與時間範圍控制進行情報爬取與結構化輸出。

##### 實戰 Prompt 範例（每日產業新聞/情報蒐集）：
...
2. 網頁爬取與資料結構化：
   - 使用 claude in chrome 開啟並檢視權威財經與科技媒體（如：經濟日報、工商時報、科技新報 TechNews、電子時報 DIGITIMES）。
