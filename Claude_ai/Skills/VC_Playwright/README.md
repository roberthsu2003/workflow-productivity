...
```
┌─────────────────────────────────────────────────────────────────────────────────────────────────┐
│                           🇹🇼 台灣在地創投 4 大實戰案例網址與示範主題                               │
├──────────────────────────┬──────────────────────────────────────┬───────────────────────────────┤
│ 演練主題                 │ 台灣在地測試網址 (Taiwan Target URLs)│ 創投商業關注點 (VC Metrics)   │
├──────────────────────────┼──────────────────────────────────────┼───────────────────────────────┤
│ 案例 1：無人機國家隊     │ 智飛科技 (https://www.taiwan-uav.com)│ 非紅供應鏈、軍規光電/飛控技術 │
│          盡職調查 (DD)   │ vs 經緯航太 (https://www.geosat.com.tw)│ 自研率、災防與防衛標案營收      │
├──────────────────────────┼──────────────────────────────────────┼───────────────────────────────┤
│ 案例 2：矽光子與邊緣 AI  │ 創鑫智慧 (https://www.neuchips.ai)   │ 算力能效比 (TOPS/W)、         │
│          晶片市場地圖    │ vs 耐能智慧 (https://www.kneron.com) │ 地端生成式 AI 晶片 vs CPO 封裝 │
├──────────────────────────┼──────────────────────────────────────┼───────────────────────────────┤
│ 案例 3：台灣新創標的發現 │ 創業小聚 (https://meet.bnext.com.tw) │ 台灣 Meet Neo Star 評選熱門、 │
│          (Deal Source)   │ FINDIT 平台 (https://findit.org.tw)  │ 早期募資訊號、垂直賽道潛力    │
├──────────────────────────┼──────────────────────────────────────┼───────────────────────────────┤
│ 案例 4：工業 AI 投後營運 │ 杰倫智能 (https://www.profetai.com/careers)│ 製造業 SaaS 落地速度、        │
│          與擴張追蹤      │ 產品發布 (https://www.profetai.com) │ 海外拓展（日本/東南亞）招募   │
└──────────────────────────┴──────────────────────────────────────┴───────────────────────────────┘
```
